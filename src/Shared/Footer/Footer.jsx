...
const Footer = () => {
    return (
        <div className='bg-gray-500 lg:h-[70vh] h-[90vh] relative'>
            ...
            <div className='p-5 rounded-lg absolute lg:top-1/2 top-[13%] md:top-[30%] text-black lg:w-1/3 w-3/4 lg:left-[9%] left-[4%]'>
                <div className='flex items-center'>
                    <img className='w-20' src="logo.png" alt="" />
                    <h1 className='lg:text-5xl text-2xl pe-7 font-semibold italic'>Turbo Thriller</h1>
                </div>
